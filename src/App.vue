<template>
  <div class="flex justify-center">
    <div class="flex flex-col w-[400px] items-center justify-center py-40">
      <div class="bg-black p-4 rounded-2xl shadow-md">
        <div
          class="flex justify-end bg-black text-white p-2 h-11 rounded mb-4 text-2xl font-semibold"
        >
          {{ currentInput }}
        </div>
